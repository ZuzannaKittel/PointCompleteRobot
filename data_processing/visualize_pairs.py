...
def visualize_saved_pair_truthful(pt_file_path):
    ...
    ax2.scatter(gt_pts[:, 0], gt_pts[:, 1], gt_pts[:, 2], c='purple', s=1, alpha=0.8)
    ...
    ax3.scatter(gt_pts[:, 0], gt_pts[:, 1], gt_pts[:, 2], c='gray', s=1, alpha=0.1)
...
# Usage
visualize_saved_pair_truthful("./data/geometric_pairs_dataset/train/pair_00004_7b6477cb95_chair_19.pt")
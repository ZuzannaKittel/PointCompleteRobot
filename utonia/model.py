...
class SerializedAttention(PointModule):
    def __init__(
        ...
        if enable_flash:
            ...
            # assert flash_attn is not None, "Make sure flash_attn is installed." # IGNORE - flash_attn is an optional dependency, problem with installation in the cluster environment, so we will just catch the error when trying to use it.
            self.patch_size = patch_size
